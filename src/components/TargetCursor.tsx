...
const getContainingBlockOffset = (block: HTMLElement | null): CursorPosition => {
...
const TargetCursor = ({
  ...
  const targetCornerPositionsRef = useRef<CursorPosition[] | null>(null);
  ...
  useEffect(() => {
    ...
    const enterHandler = (e: MouseEvent) => {
      const directTarget = e.target instanceof HTMLElement ? e.target : null;
